                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                if(radioButton.getId() == R.id.korisnik) {
                                    ...
                                    Toast.makeText(RegisterActivity.this, "Успешно се креираше корисник", Toast.LENGTH_SHORT).show();
                                    ...
                                    user.updateProfile(profileUpdates);
                                    Toast.makeText(RegisterActivity.this,"Успешно се креираше доставувач",Toast.LENGTH_SHORT).show();
                                    ...
                                    user.updateProfile(profileUpdates);
                                    Toast.makeText(RegisterActivity.this,"Успешно се креираше администратор",Toast.LENGTH_SHORT).show();
